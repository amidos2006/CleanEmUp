...
{
    public class MosiacObject:BaseObject
    {
        public MosiacObject(double timeTillRemoval)
            : base(timeTillRemoval, new Color(20, 50, 80))
        {
            CurrentImages.Add(new Image(OGE.Content.Load<Texture2D>(@"Graphics\Entities\Objects\MosiacObject")));
