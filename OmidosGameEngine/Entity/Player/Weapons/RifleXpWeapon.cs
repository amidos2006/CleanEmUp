...
{
    public class RifleXpWeapon : BaseWeapon
    {
        public RifleXpWeapon() :
            base(0.8f)
        {
            numberOfBullets = 2;
            bulletSpeed = 15;
            ...
            GunName = GlobalVariables.Data.Weapons[12].Name;
        }
        ...
        public override void LoadContent()
        {
            ...
            TurnetImage = new Image(OGE.Content.Load<Texture2D>(@"Graphics\Entities\Players\Weapons\RifleXP"));
