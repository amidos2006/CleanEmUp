...
{
    public class HomingRocketLauncherWeapon : BaseWeapon
    {
        public HomingRocketLauncherWeapon() :
            base(1.1f)
        {
            numberOfBullets = 1;
            bulletSpeed = 15;
            ...
            GunName = GlobalVariables.Data.Weapons[13].Name;
        }
        ...
        public override void LoadContent()
        {
            ...
            TurnetImage = new Image(OGE.Content.Load<Texture2D>(@"Graphics\Entities\Players\Weapons\HomingMissle"));
