...
namespace OmidosGameEngine.Entity.Player.Weapons
{
    public class MinigunWeapon : BaseWeapon
    {
            ...
            base(0.1f)
        {
            ...
            GunName = GlobalVariables.Data.Weapons[7].Name;
        }
        ...
        public override void LoadContent()
        {
            ...
            TurnetImage = new Image(OGE.Content.Load<Texture2D>(@"Graphics\Entities\Players\Weapons\Minigun"));
        ...
        public override bool GenerateBullet(Vector2 position, float direction, float bonusAccuracy)
        {
            ...
            if (bulletGenerated)
            {
                for (int i = 0; i < numberOfBullets; i++)
                {
                    ...
                    bullet = new MinigunBullet(position, (float)(bulletSpeed * (1 - 0.1 * random.NextDouble())),
