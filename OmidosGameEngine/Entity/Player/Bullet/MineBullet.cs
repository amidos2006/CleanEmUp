...
{
    public class MineBullet : PlayerBullet
    {
        ...
        public MineBullet(Vector2 startingPoint, float speed, float direction, float maxDistance)
            : base(startingPoint, speed, direction, maxDistance)
        {
            ...
            particlePrototype.ParticleColor = new Color(255, 100, 20);
            ...
            this.ExplosionColor = new Color(255, 100, 20);
