...
{
    public class Hackintosh2Enemy: BaseEnemy
    {
        private Alarm generateAlarm;
        private CircleParticleGenerator circleGenerator;

        public Hackintosh2Enemy()
            :base(new Color(80,130,20))
        {
            InsideScreen = true;
            ...
            CurrentImages.Add(new Image(OGE.Content.Load<Texture2D>(@"Graphics\Entities\Enemies\Hackintosh2")));
            ...
            this.circleGenerator.NumberOfCircles = 2;
            ...
            this.generateAlarm = new Alarm(3f, TweenType.Looping, new AlarmFinished(GenerateTrojan));
