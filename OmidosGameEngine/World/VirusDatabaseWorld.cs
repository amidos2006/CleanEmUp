...
{
    public class VirusDatabaseWorld : BaseWorld
    {
        private List<VirusEnemy> viruses;
        private Dictionary<Type, EnemyData> newViruses;

        public VirusDatabaseWorld(Dictionary<Type, EnemyData> newViruses, BloomComponent bloomComponent)
        ...
        public override void Intialize()
        {
            ...
            VirusButtonAnnouncerEntity announcer = new VirusButtonAnnouncerEntity(null, new Color(150, 255, 130), newViruses, 
                "Return to Armory Console", GoToArmory);
        ...
        private void GoToArmory()
        {
            OGE.NextWorld = new ArmoryWorld(bloomPostProcess);
