...
namespace BloomPostprocess
{
    public class BloomComponent : DrawableGameComponent
    {
        ...
        //UnbloomedTexture
        RenderTarget2D unbloomedTexture;
        public RenderTarget2D UnBloomedTexture
        {
            get
            {
                return unbloomedTexture;
            }
        }
        ...
        protected override void LoadContent()
        {
            ...
            //Unbloomed texture
            unbloomedTexture = new RenderTarget2D(GraphicsDevice, width, height, false,
                                                   format, pp.DepthStencilFormat, pp.MultiSampleCount,
                                                   RenderTargetUsage.DiscardContents);
        ...
        {
            //Set the unbloomed Texture
            DrawFullscreenQuad(sceneRenderTarget, unbloomedTexture,
                               null, IntermediateBuffer.BlurredBothWays);
